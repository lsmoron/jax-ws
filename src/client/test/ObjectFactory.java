 ...
 * generated in the client.test package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayHelloWorldFromResponse_QNAME = new QName("http://test", "sayHelloWorldFromResponse");
    private final static QName _SayHelloWorldFrom_QNAME = new QName("http://test", "sayHelloWorldFrom");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: client.test
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test", name = "sayHelloWorldFromResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://test", name = "sayHelloWorldFrom")
